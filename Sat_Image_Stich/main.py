...
def main():
    ...
    st.subheader("Unstiched Images:")
    col1, col2, col3 = st.columns(3)

    # Display each image in a separate column
    with col1:
        st.image(image_paths[0], use_column_width=True, caption='Image 1')

    with col2:
        st.image(image_paths[1], use_column_width=True, caption='Image 2')

    with col3:
        st.image(image_paths[2], use_column_width=True, caption='Image 3')
